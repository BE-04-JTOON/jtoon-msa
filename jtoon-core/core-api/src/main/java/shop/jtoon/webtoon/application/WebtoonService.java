...
import shop.jtoon.webtoon.repository.WebtoonSearchRepository;
import shop.jtoon.webtoon.request.CreateWebtoonReq;
import shop.jtoon.webtoon.request.GetWebtoonsReq;
import shop.jtoon.webtoon.response.GenreRes;
...
public class WebtoonService {
	...
	private List<GenreRes> getGenres(Webtoon webtoon) {
		return genreWebtoonRepository.findByWebtoon(webtoon).stream().map(GenreRes::from).toList();
	}
